    ...
    for (const dir of dirs) {
        ...
        for (const file of files) {
            ...
            if (stat.isDirectory())
                ...
                if (file.endsWith('.js')) {
                    try {
                        const cmdModule: Command = new (require(path.join(__dirname, dir, file)))(client);
                        ...
                        client.utils.log('ERROR', 'src/registry.js', `Error loading commands: ${e}`);
                    }
                }
            }
        }
            ...
            if (stat.isDirectory())
                ...
                if (file.endsWith('.js')) {
                    ...
                    try {
                        ...
                        client.utils.log('ERROR', 'src/registry.js', `Error loading events: ${e}`);
                    }
                }
            }
        }
